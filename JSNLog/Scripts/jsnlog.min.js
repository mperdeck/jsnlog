...
"jsnlog.logger"};__extends(h,e);h.prototype.setOptions=function(a){c("url",a,this);e.prototype.setOptions.call(this,a);return this};h.prototype.sendLogItemsAjax=function(a){try{var c=JSON.stringify({r:b.requestId,lg:a}),d=new XMLHttpRequest;d.open("POST",this.url);d.setRequestHeader("Content-Type","application/json");d.send(c)}catch(e){}};i=h;b.AjaxAppender=i;var f=function(a){this.loggerName=a};f.prototype.stringifyLogObject=function(a){switch(typeof a){case "string":return a;case "number":return a.toString();
case "boolean":return a.toString();case "undefined":return"undefined";case "function":return a instanceof RegExp?a.toString():a();case "object":return a instanceof RegExp||a instanceof String||a instanceof Number||a instanceof Boolean?a.toString():JSON.stringify(a);default:return"unknown"}};f.prototype.setOptions=function(a){c("level",a,this);c("userAgentRegex",a,this);c("ipRegex",a,this);c("appenders",a,this);return this};f.prototype.log=function(a,b){var c=0,d;if(this.appenders){if(a>=this.level&&
g(this)){d=this.stringifyLogObject(b);for(c=this.appenders.length-1;0<=c;)this.appenders[c].log(a,d,this.loggerName),c--}return this}};f.prototype.trace=function(a){return this.log(1E3,a)};f.prototype.debug=function(a){return this.log(2E3,a)};f.prototype.info=function(a){return this.log(3E3,a)};f.prototype.warn=function(a){return this.log(4E3,a)};f.prototype.error=function(a){return this.log(5E3,a)};f.prototype.fatal=function(a){return this.log(6E3,a)};b.Logger=f;f=new i("");b.__=new b.Logger("");
b.__.setOptions({level:b.getDebugLevel(),appenders:[f]});b.createAjaxAppender=function(a){return new i(a)}})(JL||(JL={}));
